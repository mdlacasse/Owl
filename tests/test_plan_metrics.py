...
EXPECTED_KEYS = [
    "spending_basis", "spending_year1",
    "effective_tax_rate",
    "total_spending_today", "total_spending_nominal",
    "total_fixed_income_today", "total_fixed_income_nominal",
    "ss_income_today", "ss_income_nominal",
    "pension_income_today", "pension_income_nominal",
    "roth_conversions_today", "roth_conversions_nominal",
    "federal_income_tax_today", "federal_income_tax_nominal",
    "ltcg_tax_today", "ltcg_tax_nominal",
    "niit_today", "niit_nominal",
    "state_tax_today", "state_tax_nominal",
    "medicare_today", "medicare_nominal",
    "aca_today", "aca_nominal",
    "debt_payments_today", "debt_payments_nominal",
    "heirs_tax_liability_nominal",
    "final_bequest_today", "final_bequest_nominal",
    "remaining_debt_balance",
    "time_horizon_years", "inflation_factor",
]
...
def test_plan_to_dict_top_level_keys(solved_single):
    ...
    for key in ("status", "case_name", "objective", "summary", "by_year",
                "individuals", "start_year", "end_year", "time_horizon_years"):
...
def test_plan_to_dict_by_year_fields(solved_single):
    d = plan_to_dict(solved_single)
    row = d["by_year"][0]
    for field in ("year", "ages", "spending", "federal_income_tax",
                  "roth_conversions", "portfolio_total"):
