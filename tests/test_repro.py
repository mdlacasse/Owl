...
def test_case2():
    ...
    assert p.bequest == pytest.approx(595944.0, abs=0.5)
...
def test_config1():
    ...
    assert p2.bequest == pytest.approx(595944.0, abs=0.5)
    ...
    assert p3.bequest == pytest.approx(595944.0, abs=0.5)
