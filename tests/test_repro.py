...
def test_case1():
    ...
    assert p.basis == pytest.approx(74497, abs=0.5)
...
def test_case2():
    ...
    assert p.bequest == pytest.approx(233183, abs=0.5)
...
def test_config1():
    ...
    assert p2.bequest == pytest.approx(233183, abs=0.5)
    os.remove(filename)
