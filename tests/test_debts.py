"""
Tests for debts module - debt calculation and management functions.

Tests verify functions for calculating loan payments, remaining balances,
and debt-related financial planning calculations.
