...
| `method` | string | Method for determining rates. Valid values: `"trailing-30"`, `"optimistic"`, `"conservative"`, `"user"`, `"historical"`, `"historical average"`, `"gaussian"`, `"histogaussian"`, `"lognormal"`, `"histolognormal"`, `"bootstrap_sor"`, `"var"`, `"garch_dcc"`, `"gmm"`, `"dataframe"` |
...
#### :orange[For method = "gaussian", "histogaussian", "lognormal", "histolognormal", "bootstrap_sor", "var", "garch_dcc", or "gmm"]
| Parameter | Type | Description |
|-----------|------|-------------|
...
#### :orange[For method = "historical", "historical average", "histogaussian", "histolognormal", "bootstrap_sor", "var", "garch_dcc", or "gmm"]
| Parameter | Type | Description |
|-----------|------|-------------|
...
#### :orange[For method = "historical", "histogaussian", "histolognormal", "bootstrap_sor", "var", "garch_dcc", "gmm", "gaussian", or "lognormal" (varying rates only)]
| Parameter | Type | Description |
|-----------|------|-------------|
