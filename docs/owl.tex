...
\paragraph*{Account balances}
	...
	optimization. This approach is perfectly valid as long as the asset allocation
	ratios are the same in both accounts.

	There is also another null space involving an overwithdrawal from the taxable
