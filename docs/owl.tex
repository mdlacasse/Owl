...
\item [$G_n$]
	...
	\begin{eqnarray}
		...
		+ (1-\delta(k, 0))(b_{i0n} - w_{i0n} + .5\kappa_{i0n})\alpha_{i0kn}\tau_{kn}]
	\end{eqnarray}
...
\item [$Q_n$]
	...
	\begin{equation}
		\label{Eq:Qx2}
		Q_n = \sum_{i} \alpha_{i00n}\left[(b_{i0n} - w_{i0n} + .5\kappa_{i0n})\mu +
...
\paragraph*{Account balances}
	...
	Therefore, our current choice would yeild
	\begin{eqnarray}
		\label{Eq:C3a}
	...
	account followed by a deposit in the same account at the end of the year. This can 
...
\paragraph*{Net spending}
	...
	\begin{eqnarray}
		...
		- T_n - U_n.
	\end{eqnarray}
	Note how the big-ticket items $\Lambda^\pm$ contribute directly to the cash flow.
	...
	\begin{eqnarray}
		...
		- \psi\mu\alpha_{i00n} \sum_{i} \left[b_{i0n} - w_{i0n} + d_{in}
		+ w_{i0n}\max(0, \tau_{0n-1})\right] 
