...
\end{eqnarray}
The formulation below will therefore use $\matcal{T}_{ijn}$ to
add the market return to the savings balances.
...
\paragraph*{Account balances}
	...
	From an optimization point of view, and in years of positive returns,
	a direct withdrawal from the tax-deferred account will always
	be unfavored against a Roth conversion taking place
	...
	are made at the beginning of the year, and surplus deposits, if needed, are made at the end of the year.
