...
\paragraph*{Account balances}
	...
	it is desirable to make Roth conversions and tax-deferred distributions exclusive events
	...
	the same strategy as Eq.~(\ref{Eq:Binary}). Another simpler approach, while not so natural,
