"""Generate the modest-portfolio example case (Case_sam.toml + HFP_sam.xlsx).

Sam is Dana scaled to roughly a tenth of the savings, with Social Security scaled to
...
HFP_OUT = "examples/HFP_sam.xlsx"
TOML_OUT = "examples/Case_sam.toml"
...
def main():
    ...
    # No home: Sam rents, which is what keeps taxable income under the deduction.
