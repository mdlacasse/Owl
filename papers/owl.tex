...
Security benefits, Roth account rules, Medicare premiums, capital gains tax,
the Net Investment Income Tax, and ordinary income tax---with notes on how
each is implemented and where known limitations apply.
...
Pension survivorship rules (e.g.\ joint-and-survivor annuity options) are
not modeled; the pension is assumed to cease at the death of the individual
who holds it.
...
The method names \texttt{stochastic} and \texttt{histochastic} are
deprecated aliases for \texttt{gaussian} and \texttt{histogaussian}
respectively; they are still accepted for backward compatibility but
new cases should use the canonical names.
