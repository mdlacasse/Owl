...
\subsection{Multivariate normal: \texttt{histochastic} and \texttt{stochastic}}
...
\end{eqnarray}
For \texttt{stochastic}, the user supplies $\bm{\mu}$ directly, together
...
(\texttt{histochastic}, \texttt{stochastic}, \texttt{bootstrap\_sor},
\texttt{var}, or \texttt{garch\_dcc}) independently
