...
Adding binary variables $z_{nz}$ with $z \in \{0, 1, 2, 3\}$ can add $4N_n$ more decision variables,
while adding $z^m_{qn}$ adds $6N_n$ more, resulting in $(24 + 4 + 6) N_n + 6 = 34 N_n + 6$, or 1,026 for 30 years.
